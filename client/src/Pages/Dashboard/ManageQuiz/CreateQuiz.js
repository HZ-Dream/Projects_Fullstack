...
const CreateQuiz = () => {
    ...
    const validateSubmit = () => {
        if (formField.title.trim() === '' || formField.description.trim() === '' || formField.duration.trim() === '') {
        ...
        try {
            ...
            postData('/api/quiz/createQuiz', finalFormField)
                .then((res) => {
                    ...
                    setTimeout(() => {
                        window.location.href = '/dashboard/quizList';
                    }, 1000);
                })
                .catch((err) => {
                    setIsLoad(false);
                    ...
                    <div className="col-sm-7">
                        <div className="card p-4">
                            ...
                            <div className="form-group">
                                <h6>Title*</h6>
                                <input onChange={onChangeInput} name="title" type="text" />
                            </div>
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={onChangeInput} name="duration" type="text" placeholder="30" />
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    <div className="form-group">
